module.exports = async function handler(req,res){
  ...
  try{
    ...
    const headers={apikey:'sb_publishable_kexH74ejNOb7IM-Lzikouw_22xRKSR7','content-type':'application/json'};
    if(auth.startsWith('Bearer ')) headers.authorization=auth;
    const r=await fetch('https://zzjcimwqttlqrcjiuffm.supabase.co/functions/v1/lead-outreach',{method:'POST',headers,body:JSON.stringify(payload)});
